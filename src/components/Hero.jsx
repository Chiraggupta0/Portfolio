    ...
    <section id="hero" className="min-h-screen flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 py-20 relative z-10">
        ...
        <motion.h1 {...fadeUp(0.2)} className="font-display text-6xl md:text-8xl text-ink-900 dark:text-ink-50 leading-[0.95] mb-6">
          ...
          <span className="text-ink-600 dark:text-ink-600 italic">{personal.name.split(" ")[1]}</span>
        </motion.h1>
        ...
        <motion.div {...fadeUp(0.6)} className="flex flex-wrap items-center gap-4">
          <a href="#projects" className="inline-flex items-center gap-2 px-6 py-3 bg-amber-600 text-white font-medium text-sm rounded-sm hover:bg-amber-700 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-600/20">

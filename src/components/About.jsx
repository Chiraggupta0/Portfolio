...
export default function About() {
  return (
    <section id="about" className="bg-ink-100/50 dark:bg-ink-900/50">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 pt-2">
                {[
                  ...
                  <div
                    key={label}
                    className="bg-white/60 dark:bg-ink-800/60 border border-ink-200/60 dark:border-ink-700/60 
                               rounded-sm px-4 py-3 text-center"
                  >
